          ...
          {[
            ...
            >
              ...
              <div
                style={{
                  fontSize: 11,
                  color: NGU_HANH_COLOR[p.data.nguHanh.split("/")[0]] || MUTED,
          ...
          {nguHanhAnalysis.map((item) => (
            <div key={item.element} style={{ marginBottom: 10 }}>
              <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4 }}>
                <span style={{ fontSize: 13, color: NGU_HANH_COLOR[item.element] || TEXT, fontWeight: "bold" }}>
                  {item.element}
                </span>
              ...
              <div style={{ height: 6, background: "#1e1530", borderRadius: 3 }}>
                <div
                  style={{
                    ...
                    background: NGU_HANH_COLOR[item.element] || GOLD,
                    borderRadius: 3,
                  }}
                />
              </div>
