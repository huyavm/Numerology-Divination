...
const FEATURES = [
  {
    ...
    desc: "Tích hợp triết học phương Đông (Kinh Dịch, Tứ Trụ, Ngũ Hành) với hệ thống Numerology Pythagoras phương Tây vào một nền tảng thống nhất.",
  },
  {
    icon: "◉",
    title: "AI Giải Mã Chuyên Sâu",
    desc: "Sử dụng mô hình AI tiên tiến nhất (GPT-5.4, Gemini 3.1) được huấn luyện chuyên biệt về huyền học để đưa ra phân tích sâu sắc và cá nhân hóa.",
  },
  {
    icon: "◎",
    title: "Kiến Thức Hệ Thống",
    desc: "Thư viện kiến thức phong phú về Thiên Can Địa Chi, 64 quẻ Dịch, bảng Pythagoras, ý nghĩa con số giúp bạn tự học và tra cứu.",
  },
  {
    icon: "◐",
...
const STEPS = [
  { num: "01", title: "Chọn phương pháp", desc: "Lựa chọn trong 5 hệ thống huyền học: Thần số, Bát tự, Kinh Dịch, Cát Hung hoặc chat AI." },
    ...
    <div className="min-h-[100dvh] flex flex-col bg-background text-foreground">
      ...
      <section className="relative flex flex-col items-center justify-center min-h-[100dvh] px-4 pt-20 pb-16 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl w-full text-center space-y-8 animate-in fade-in slide-in-from-bottom-6 duration-1000">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Nền tảng huyền học toàn diện kết hợp Thần Số Học, Bát Tự Tứ Trụ, Kinh Dịch và Phong Thủy với sức mạnh của trí tuệ nhân tạo tiên tiến nhất.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-8 pt-8 border-t border-primary/10 mt-8">
            {[
              { val: "5", label: "Hệ thống huyền học" },
      ...
      <section className="py-20 px-4 relative">
        <div className="max-w-6xl mx-auto space-y-12">
          <div className="text-center space-y-3">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground">5 Môn Huyền Học</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {MODULES.map((m, i) => (
              <Link key={m.href} href={m.href} className={`group ${i === 4 ? "md:col-span-2 lg:col-span-1" : ""}`}>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {STEPS.map((s, i) => (
              <div key={s.num} className="relative text-center space-y-4">
                ...
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl border border-primary/30 bg-primary/10 text-primary text-2xl font-bold mx-auto">
                  {s.num}
                </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-3xl mx-auto text-center space-y-8">
          <div className="rounded-2xl border border-primary/25 bg-gradient-to-b from-primary/10 to-transparent p-12 space-y-6 relative overflow-hidden">
